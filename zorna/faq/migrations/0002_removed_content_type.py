...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FaqQuestion.content_type'
        db.delete_column('zorna_faq_questions', 'content_type_id')

        # Deleting field 'Faq.content_type'
        db.delete_column('zorna_faq', 'content_type_id')


    def backwards(self, orm):
        
        # Adding field 'FaqQuestion.content_type'
        db.add_column('zorna_faq_questions', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_faq_faqquestion_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Faq.content_type'
        db.add_column('zorna_faq', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_faq_faq_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
