...
class ZornaEntity(models.Model):
    """
    """
    site = models.ForeignKey(Site, null=True, related_name='site_owner_%(app_label)s_%(class)s_related', editable=False)
    owner = models.ForeignKey(User, null=True, related_name='user_owner_%(app_label)s_%(class)s_related', editable=False)
    modifier = models.ForeignKey(User, null=True, related_name='user_modifier_%(app_label)s_%(class)s_related', editable=False)
    time_created = models.DateTimeField(_('Date created'), auto_now_add=True, editable=False)
    time_updated = models.DateTimeField(_('Date updated'), auto_now=True, auto_now_add=True, editable=False)
    ...
    def delete(self, *args, **kwargs):
        ...
        ACLPermission.objects.filter(object_id=self.pk, content_type=ct).delete()
    ...
    def get_user_avatar(self, user_id):
        ...
        if entities_avatars_cache == None:
        ...
        try:
            ...
            entities_avatars_cache[user_id] = avatar_user.avatar if avatar_user else ''
