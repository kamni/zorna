...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArticleAttachments.mimetype'
        db.alter_column('zorna_articles_attachments', 'mimetype', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ArticleAttachments.mimetype'
        db.alter_column('zorna_articles_attachments', 'mimetype', self.gf('django.db.models.fields.CharField')(max_length=64))
