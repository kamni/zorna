...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArticleCategory.email_notification'
        db.add_column('zorna_articles_categories', 'email_notification', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ArticleCategory.email_notification'
        db.delete_column('zorna_articles_categories', 'email_notification')
    ...
    models = {
        ...
        'articles.articlecategory': {
            ...
            'email_notification': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
