...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Community.enable_documents'
        db.add_column('zorna_communities', 'enable_documents', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Community.email_notification'
        db.add_column('zorna_communities', 'email_notification', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Community.enable_documents'
        db.delete_column('zorna_communities', 'enable_documents')

        # Deleting field 'Community.email_notification'
        db.delete_column('zorna_communities', 'email_notification')
