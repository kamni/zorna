...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventCommunity'
        db.create_table('zorna_community_messages_events', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Event'])),
        ))
        db.send_create_signal('communities', ['EventCommunity'])


    def backwards(self, orm):
        
        # Deleting model 'EventCommunity'
        db.delete_table('zorna_community_messages_events')
