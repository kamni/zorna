...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UrlCommunity'
        db.create_table('zorna_community_urls', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='site_owner_communities_urlcommunity_related', null=True, to=orm['sites.Site'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_owner_communities_urlcommunity_related', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_modifier_communities_urlcommunity_related', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('communities', ['UrlCommunity'])


    def backwards(self, orm):
        
        # Deleting model 'UrlCommunity'
        db.delete_table('zorna_community_urls')
