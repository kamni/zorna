...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ZornaNoteCategory.content_type'
        db.delete_column('zorna_note_categories', 'content_type_id')

        # Deleting field 'ZornaNote.content_type'
        db.delete_column('zorna_notes', 'content_type_id')


    def backwards(self, orm):
        
        # Adding field 'ZornaNoteCategory.content_type'
        db.add_column('zorna_note_categories', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_notes_zornanotecategory_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'ZornaNote.content_type'
        db.add_column('zorna_notes', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_notes_zornanote_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
