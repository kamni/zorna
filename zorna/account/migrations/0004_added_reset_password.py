...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.reset_password_key'
        db.add_column('zorna_userprofile', 'reset_password_key', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.reset_password_key'
        db.delete_column('zorna_userprofile', 'reset_password_key')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'reset_password_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '40'}),
