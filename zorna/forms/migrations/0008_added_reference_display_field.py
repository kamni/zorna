...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormsFormField.reference_display'
        db.add_column('zorna_forms_form_field', 'reference_display', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'FormsForm.bind_display'
        db.add_column('zorna_forms_form', 'bind_display', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormsFormField.reference_display'
        db.delete_column('zorna_forms_form_field', 'reference_display')

        # Deleting field 'FormsForm.bind_display'
        db.delete_column('zorna_forms_form', 'bind_display')
