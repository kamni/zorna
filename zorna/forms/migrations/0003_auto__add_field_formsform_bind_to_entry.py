...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormsForm.bind_to_entry'
        db.add_column('zorna_forms_form', 'bind_to_entry', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormsForm.bind_to_entry'
        db.delete_column('zorna_forms_form', 'bind_to_entry')
