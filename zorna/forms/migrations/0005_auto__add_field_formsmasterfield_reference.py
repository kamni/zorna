...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormsMasterField.reference'
        db.add_column('zorna_forms_master_field', 'reference', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormsMasterField.reference'
        db.delete_column('zorna_forms_master_field', 'reference')
