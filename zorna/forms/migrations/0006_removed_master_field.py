...
from zorna.forms.models import FormsFormField
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute('select * from zorna_forms_form_field')
        qs = cursor.fetchall()
        masters = {}
        for off in qs:
            masters[off[0]] = off[9]

        cursor.execute('select * from zorna_forms_master_field')
        qs = cursor.fetchall()
        master_fields = {}
        for off in qs:
            master_fields[off[0]] = off
        
        # Deleting field 'FormsFormField.field_master'
        db.delete_column('zorna_forms_form_field', 'field_master_id')

        # Deleting field 'FormsFormField.default_master_value'
        db.delete_column('zorna_forms_form_field', 'default_master_value_id')

        # Adding field 'FormsFormField.field_type'
        db.add_column('zorna_forms_form_field', 'field_type', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'FormsFormField.list'
        db.add_column('zorna_forms_form_field', 'list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.FormsList'], null=True, blank=True), keep_default=False)

        # Adding field 'FormsFormField.reference'
        db.add_column('zorna_forms_form_field', 'reference', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        if not db.dry_run:
            db.commit_transaction()
            db.start_transaction()
            form_fields = orm.FormsFormField.objects.all()
            for off in form_fields:
                mf = master_fields[masters[off.pk]]
                off.field_type = mf[3]
                off.list_id = mf[4]
                off.reference = mf[6]
                off.save()
    ...
    def backwards(self, orm):
        ...
        # Adding field 'FormsFormField.field_master'
        db.add_column('zorna_forms_form_field', 'field_master', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['forms.FormsMasterField']), keep_default=False)

        # Adding field 'FormsFormField.default_master_value'
        db.add_column('zorna_forms_form_field', 'default_master_value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.FormsListEntry'], null=True, blank=True), keep_default=False)

        # Deleting field 'FormsFormField.field_type'
        db.delete_column('zorna_forms_form_field', 'field_type')

        # Deleting field 'FormsFormField.list'
        db.delete_column('zorna_forms_form_field', 'list_id')

        # Deleting field 'FormsFormField.reference'
        db.delete_column('zorna_forms_form_field', 'reference')
