...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FormsFormEntry.content_type'
        db.delete_column('zorna_forms_form_entry', 'content_type_id')

        # Deleting field 'FormsForm.content_type'
        db.delete_column('zorna_forms_form', 'content_type_id')

        # Deleting field 'FormsWorkspace.content_type'
        db.delete_column('zorna_forms_workspace', 'content_type_id')


    def backwards(self, orm):
        
        # Adding field 'FormsFormEntry.content_type'
        db.add_column('zorna_forms_form_entry', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_forms_formsformentry_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'FormsForm.content_type'
        db.add_column('zorna_forms_form', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_forms_formsform_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'FormsWorkspace.content_type'
        db.add_column('zorna_forms_workspace', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_forms_formsworkspace_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
