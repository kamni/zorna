...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ZornaFolder.content_type'
        db.delete_column('zorna_folders', 'content_type_id')

        # Deleting field 'ZornaFile.content_type'
        db.delete_column('zorna_files', 'content_type_id')


    def backwards(self, orm):
        
        # Adding field 'ZornaFolder.content_type'
        db.add_column('zorna_folders', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_fileman_zornafolder_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'ZornaFile.content_type'
        db.add_column('zorna_files', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_fileman_zornafile_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
