...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ZornaFolder.email_notification'
        db.add_column('zorna_folders', 'email_notification', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ZornaFolder.email_notification'
        db.delete_column('zorna_folders', 'email_notification')
