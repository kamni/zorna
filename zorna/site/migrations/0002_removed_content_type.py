...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SiteAlert.content_type'
        db.delete_column('zorna_alerts', 'content_type_id')


    def backwards(self, orm):
        
        # Adding field 'SiteAlert.content_type'
        db.add_column('zorna_alerts', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_site_sitealert_related', null=True, to=orm['contenttypes.ContentType']), keep_default=False)
