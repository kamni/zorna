...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SiteOptions'
        db.create_table('zorna_site_options', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='site_owner_site_siteoptions_related', null=True, to=orm['sites.Site'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_owner_site_siteoptions_related', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_modifier_site_siteoptions_related', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('site', ['SiteOptions'])


    def backwards(self, orm):
        
        # Deleting model 'SiteOptions'
        db.delete_table('zorna_site_options')
