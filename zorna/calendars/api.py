...
def get_user_calendars(user, permissions=['viewer']):
    ...
    b_personal_calendar = SiteOptions.objects.is_access_valid(user, 'zorna_personal_calendar')
    ...
    for obj in allowed_objects:
        if isinstance(obj.content_object, Community) and obj.content_object.enable_calendar == False:
            exclude.append(obj)
