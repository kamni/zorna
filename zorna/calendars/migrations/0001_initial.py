...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('zorna_eventdetails', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('free_busy', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('privacy', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
        ))
        db.send_create_signal('calendars', ['EventDetails'])

        # Adding model 'ZornaCalendar'
        db.create_table('zorna_calendars', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entity_content_type_calendars_zornacalendar_related', null=True, to=orm['contenttypes.ContentType'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='site_owner_calendars_zornacalendar_related', null=True, to=orm['sites.Site'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_owner_calendars_zornacalendar_related', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_modifier_calendars_zornacalendar_related', null=True, to=orm['auth.User'])),
            ...
            ('ct_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('calendars', ['ZornaCalendar'])


    def backwards(self, orm):
        
        # Deleting model 'EventDetails'
        db.delete_table('zorna_eventdetails')

        # Deleting model 'ZornaCalendar'
        db.delete_table('zorna_calendars')
    ...
    models = {
        ...
        'calendars.zornacalendar': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entity_content_type_calendars_zornacalendar_related'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
