...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ZornaResourceCalendar'
        db.create_table('zorna_resource_calendars', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='site_owner_calendars_zornaresourcecalendar_related', null=True, to=orm['sites.Site'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_owner_calendars_zornaresourcecalendar_related', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_modifier_calendars_zornaresourcecalendar_related', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('calendars', ['ZornaResourceCalendar'])


    def backwards(self, orm):
        
        # Deleting model 'ZornaResourceCalendar'
        db.delete_table('zorna_resource_calendars')
