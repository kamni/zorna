...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ZornaCalendarCategory'
        db.create_table('zorna_calendar_categories', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='site_owner_calendars_zornacalendarcategory_related', null=True, to=orm['sites.Site'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_owner_calendars_zornacalendarcategory_related', null=True, to=orm['auth.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_modifier_calendars_zornacalendarcategory_related', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('calendars', ['ZornaCalendarCategory'])

        # Adding field 'EventDetails.category'
        db.add_column('zorna_eventdetails', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendars.ZornaCalendarCategory'], null=True), keep_default=False)

        # Adding field 'EventDetails.bgcolor'
        db.add_column('zorna_eventdetails', 'bgcolor', self.gf('django.db.models.fields.CharField')(default='', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ZornaCalendarCategory'
        db.delete_table('zorna_calendar_categories')

        # Deleting field 'EventDetails.category'
        db.delete_column('zorna_eventdetails', 'category_id')

        # Deleting field 'EventDetails.bgcolor'
        db.delete_column('zorna_eventdetails', 'bgcolor')
    ...
    models = {
        ...
        'calendars.eventdetails': {
            ...
            'bgcolor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '6'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['calendars.ZornaCalendarCategory']", 'null': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
